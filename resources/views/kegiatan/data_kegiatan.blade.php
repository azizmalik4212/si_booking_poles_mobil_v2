    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <form id="destroy-form" action="{{ route('deleteDataKegiatan') }}" method="POST" class="d-none">
            {{ csrf_field() }}
...
<div class="modal fade" id="modalAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ route('addDataKegiatan') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
              <div class="form-group">
                <label for="exampleInputEmail1">Nama kegiatan</label>
                <input type="text" name="nama_kegiatan" class="form-control" id="nama_kegiatan" aria-describedby="emailHelp" placeholder="Masukkan Nama kegiatan" required>
              </div>
              <div class="form-group">
                <label for="exampleInputEmail1">Bonus</label>
                <input type="number" name="bonus" class="form-control" id="bonus" aria-describedby="emailHelp" placeholder="Masukkan bonus" required>
              </div>
              <div class="form-group">
